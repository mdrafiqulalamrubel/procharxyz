    ...
    <AdminLayout>
      <div className="max-w-7xl mx-auto px-4 space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
         ...
         {/* BOTTOM SAVE — centered, no overlap with chatbot */}
          <div className="flex justify-center pt-4 pb-10">
            <button
              onClick={handleSave}
              disabled={saving}
              className="px-12 py-3 text-white font-bold text-base rounded-2xl bg-gradient-to-r from-blue-600 to-purple-600 hover:scale-105 hover:shadow-xl transition disabled:opacity-60 disabled:cursor-not-allowed"
            >
