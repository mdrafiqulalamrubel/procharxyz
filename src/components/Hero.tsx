...
import { ArrowRight, BarChart3, Users, CheckCircle, Mail, TrendingUp } from 'lucide-react';
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 items-center mt-10">
          ...
          >
            ...
            {/* ✅ UPDATED Social proof stats with icons */}
              ...
              {stats.map((stat, index) => {
                ...
                return (
                  <motion.div
                    ...
                    className="flex items-center gap-3 px-4 py-3 bg-white rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-shadow duration-200"
                  >
                    {/* Icon circle */}
                    ...
                    {/* Number + label */}
                    <div>
                      <div className={`text-xl font-black ${stat.numberColor}`}>
                        {stat.number}
                      </div>
